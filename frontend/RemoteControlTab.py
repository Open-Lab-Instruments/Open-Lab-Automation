...
class RemoteControlTab(QWidget):
    ...
    """
    def __init__(self, load_instruments: LoadInstruments):
        """
        ...
        self.layout.addWidget(self.meas_group)
        ...
        self.rm = pyvisa.ResourceManager()  # VISA resource manager for instrument communication
